...
//        WebPage webPage1 = new WebPage(1L,0,"webpage1",new ArticlePreviewText(),webPage1Dates, null);
//
//        Dates webPage2Dates = new Dates(LocalDateTime.of(2023, 1, 2, 10, 0,0), LocalDateTime.of(2023,1,2,10,0,0));
//        WebPage webPage2 = new WebPage(2L, 0, "webpage2", new ArticlePreviewText(), webPage2Dates, null);
