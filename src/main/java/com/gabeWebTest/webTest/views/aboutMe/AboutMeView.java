...
//        cvBlock.getStyle().set("margin","auto");
        ...
        Html htmlContent = new Html("<a href=\"/pdf/CVAug2025GabrielWright.pdf\" target=\"_blank\">CV</a>");
    ...
    private Html getPdfViewer() {
        Html pdfViewer = new Html("<embed src='pdf/CVAug2025GabrielWright.pdf' type='application/pdf' width='50%' height='600px' />");
