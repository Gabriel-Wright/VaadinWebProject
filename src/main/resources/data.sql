...
UPDATE "WEB_PAGE" SET ARTICLE_TEXT = '<v,1>"Memories of Murder" is a South Korean crime-drama film directed by Bong Joon-ho, released in 2003. [p] <h,>brahHello welcome to this article brahHello welcome to this article brah[p] <h,>Hello welcome to this article brahHello welcome to this article brahHello welcome to this article brahHello welcome to this article brahHello welcome to this article brahHello welcome to this article brahHello welcome to this article brahHello welcome to this article brahHello welcome to this article brah' WHERE id = -1000;
...
UPDATE "WEB_PAGE" SET ARTICLE_TEXT = 'Artificial intelligence (AI) pathfinding approaches are fundamental in various fields, including robotics, video games, logistics, and more. [p] <h,>These approaches aim to find the most efficient path from a starting point to a goal location, navigating through obstacles and constraints. Here are some common AI pathfinding approaches:' WHERE id = -1002;
