...
UPDATE WEB_PAGE SET ARTICLE_TEXT = '<v,2>"Memories of Murder"' WHERE id = 1000;
update WEB_PAGE SET ARTICLE_TEXT = '<v,0>Developing games using JFRAME' WHERE id =1001;
update WEB_PAGE SET ARTICLE_TEXT = '<l,2> Artificial Intelligent (AI)' where id = 1002;
